...
## Prompt
```
prompt = """masterpiece,masterpiece portrait,best quality,extremely detailed,photo,photorealistic,
depth of field,realistic lighting,1girl,solo,Instagram model,character focus,(mature woman),
(sexy expression),(large breasts),green bikini,orange hair,ponytail,underboob"""
```
